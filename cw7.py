...
# To nie zadziala, bo ta macierz ma podwojna wartosc wlasna, ktora jest jednoczesnie wartoscia dominujaca

print(rayleigh(np.array([[-1,2,2],[2,2,-1.],[2,-1,2]]), 0.01, 2, np.random.rand(3)))
